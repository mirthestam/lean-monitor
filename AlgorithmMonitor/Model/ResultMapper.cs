...
namespace Monitor.Model
{
    ...
    public static class ResultMapper
    {
        ...
        private static TimeStampChartPoint MapToTimeStampChartPoint(this ChartPoint point)
        {
        ...
        private static ChartPoint MapToChartPoint(this TimeStampChartPoint point)
        {
            return new ChartPoint
            {
                // QuantConnect chartpoints are always in Unix TimeStamp
                x = point.X.ElapsedSeconds,
                y = point.Y
            };
        }
